var socialPopupComponentModule = angular.module('socialPopupComponentModule', ['ngCookies', 'SSApp']);

socialPopupComponentModule.component('socialPopupComponent', {
  templateUrl: 'app/components/popup/socialPopupView.html',
  bindings: {
    socialProduct: '<',
    socialTab: '<'
  },
  controller: ['$timeout', '$cookies', 'SocialProductService', 'setSocialData', 'updateUserActivity', 'UserService', 'toastr', 'Slug', '$location', function($timeout, $cookies, SocialProductService, setSocialData, updateUserActivity, UserService, toastr, Slug, $location){
    /*var vm = scope.vm = {
        social: {},
        activeTab: 'like',
        complete: {}
