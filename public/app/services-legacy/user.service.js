...
(function () {
  ...
  UsersService.$inject = ['$resource', '$window', '$interval', 'toastr'];

  function UsersService($resource, $window, $interval, toastr) {
    ...
    angular.extend(Users, {
      ...
      userMailexist: function (credentials) {
        return this.mailexist(credentials).$promise;
      },
