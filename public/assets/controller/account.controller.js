...
(function () {
    ...
    angular.module('SSApp').controller('accountController', accountController);
    accountController.$inject = ['$scope', '$http', 'Upload', '$route', '$routeParams', '$location', 'UserService', '$filter', '$window', 'toastr'];

    function accountController($scope, $http, Upload, $route, $routeParams, $location, User, $filter, $window, toastr) {
        $scope.upclass = 0;
        ...
        $scope.update_username = function ($event) {
            ...
            $http
                .post('/user/profile', {userfields: jsonProduct})
                .success(function () {
