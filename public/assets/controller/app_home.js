...
UserApp.controller("mainCtrl", function ($scope, getbrandlistfact,searchServiceCatalog, searchServiceCount, twoTapService, $q, setRequiredfieldCart, $window, $http, $cookies, $location, $routeParams, $route, $filter, $log, $timeout, Slug, $interval, $anchorScroll, $sce, $rootScope, Authentication) {
    ...
    function removeCookieUnsigned(log) {
        if (log) {
            console.log('removeCookieUnsigned -> ' + log);
        }
    ...
    function initializeUser(data) {
        ...
        removeCookieUnsigned('initializeUser area');
        ///////////////
    ...
    (function loginSetup() {
        ...
        $scope.signout = (function signoutSetup() {
            ...
            function logoutUser() {
                ...
                $scope.purchase_button = "";
                $scope.userinfo = free_me;
                // removeCookieUnsigned('signout area');
    ...
    $scope.searchSpecificBrand = function(global){
        if (global) {
        ...
        $scope.selected_brandlist[0] = $scope.current_product.brand;
        $scope.selectedKeyWord = $scope.current_product.brand;
        $scope.searchforstring = $scope.current_product.brand;
        searchdatabase();
    }
    //// search database
    ...
    $scope.initTwotapCheckoutCart = function (up2) {
        var timeCurrent, t;
        $scope.ck_all = true;
        if (!Date.now) {
            timeCurrent = function now() {
        ...
        $scope.itemQuantity = [];
        var obj = up2 || $scope.userprofile2;     // my custom cart data
