///////////////// CUSTOMIZE UR SHOP /////////////////////////////////////////////
SSApp.controller('customizeTopshopController', ['$scope', '$http', '$route', '$routeParams', '$location', function ($scope, $http, $route, $routeParams, $location) {

  $scope.$parent.addTobagPossible = true;
  $scope.$parent.ck_all = true;

  // if ($scope.loggedin == 0 || $scope.loggedin === undefined ) {
  // $scope.$parent.after_login_location = '/customizeshop';
  // sShoppable.ssLogIn();
