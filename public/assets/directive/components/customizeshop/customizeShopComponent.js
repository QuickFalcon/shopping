angular.module('SSApp').directive('customizeShopComponent', ['$http', '$route', '$routeParams', '$location', function($http, $route, $routeParams, $location) {
    return {
        restrict: 'E',
        templateUrl: 'assets/directive/components/customizeshop/customizeShopView.html',
        link: function (scope) {
