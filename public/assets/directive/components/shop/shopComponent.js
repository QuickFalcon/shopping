angular.module('SSApp').directive('shopComponent', ['$http', '$route', '$routeParams', '$location', function ($http, $route, $routeParams, $location) {
    return {
        restrict: 'E', 
        templateUrl: 'assets/directive/components/shop/shopView.html', 
        link: function (scope) {
            ...
            scope.tabH = {
                tabHoptions: [
                    ...
                    { id: '8', name: 'HOME' },
                    { id: '9', name: 'GIFTS' },
                    { id: '10', name: 'CUSTOMIZE' }
                ], 
                selectedItem : { id: '1', name: 'DASHBOARD' }
            };
            ...
            scope.removetopten = function (store_name, menuitem) {
                ...
                var available = false, store, message = "";
                if (menuitem == "dashboard") {
                    if (angular.isDefined(scope.userstoptenDashboard)) {
                        w_index = scope.userstoptenDashboard.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenDashboard};
                    ...
                    if (angular.isDefined(scope.userstoptenWomen)) {
                        w_index = scope.userstoptenWomen.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenWomen};
                    ...
                    if (angular.isDefined(scope.userstoptenMen)) {
                        w_index = scope.userstoptenMen.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenMen};
                    ...
                    if (angular.isDefined(scope.userstoptenShoes)) {
                        s_index = scope.userstoptenShoes.indexOf(store_name); // women index
                        if (s_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenShoes};
                    ...
                    if (angular.isDefined(scope.userstoptenAccessories)) {
                        w_index = scope.userstoptenAccessories.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenAccessories};
                    ...
                    if (angular.isDefined(scope.userstoptenBeauty)) {
                        w_index = scope.userstoptenBeauty.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenBeauty};
                    ...
                    if (angular.isDefined(scope.userstoptenKids)) {
                        w_index = scope.userstoptenKids.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenKids};
                    ...
                    if (angular.isDefined(scope.userstoptenHome)) {
                        w_index = scope.userstoptenHome.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenHome};
                    ...
                    if (angular.isDefined(scope.userstoptenGifts)) {
                        w_index = scope.userstoptenGifts.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
                            store = {"menuitem": menuitem, "storelist": scope.userstoptenGifts};
                    ...
                    if (angular.isDefined(scope.userstoptenLocal)) {
                        w_index = scope.userstoptenLocal.indexOf(store_name); // women index
                        if (w_index > -1) {
                            available = true;
            ...
            scope.updatetopten= function (store_name, menuitem) {
                var store = { "menuitem": menuitem, "store_name": store_name },message;
                if (scope.loggedin != 1) {
                    scope.after_login_location = '/customizeshop';
                    sShoppable.ssLogIn();
                    return;
            ...
            function removefromtopten(menuitem, storelist) {
                var store = { "menuitem": menuitem, "storelist": storelist };
