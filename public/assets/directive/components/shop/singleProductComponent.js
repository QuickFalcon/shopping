angular.module('SSApp').directive('singleProductComponent', ['$http', '$routeParams', 'searchServiceCount', 'searchServiceCatalog', '$route', '$window', '$sce', '$interval', '$cookies', '$location', 'SocialProductService', function($http, $routeParams, searchServiceCount, searchServiceCatalog, $route, $window, $sce, $interval, $cookies, $location, SocialProductService){
    return {
      restrict: 'E',
      templateUrl: 'assets/directive/components/shop/singleProductView.html',
      ...
      scope.showMoreLikes = false;
          ...
          function retrive_product_data(catalogId) {
              searchServiceCatalog.searchOperationProsperentProductByCatalog(catalogId).then(function (responsep) {
                  ...
                  scope.$parent.$parent.common_popup_header = "Error Product Details ";
                  scope.$parent.$parent.common_popup_message = err;
