angular.module('SSApp').directive('searchResultComponent', ['$http', '$routeParams', '$location','categoryNode', function($http, $routeParams, $location, categoryNode){
  var template = '';
  var path = $location.path();

  if(path == '/search2')
    template = 'assets/directive/components/search/searchResultView2.html';
  else
    template = 'assets/directive/components/search/searchResultView.html';
