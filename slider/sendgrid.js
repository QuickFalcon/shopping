...
exports.sendTemplate = function(options, req, cb) {
  var template = options.template || 'generic';
...
exports.sendgridEmail = function (userDetails, message, userObj) {
  ...
  var toptext = '<!doctype html public "- / /w3c / /dtd xhtml 1.0 strict / /en" "http: / /www.w3.org /tr /xhtml1 /dtd /xhtml1-strict.dtd">' + '\n' +
      ...
      '<tr>' + '\n' +
      '<td style="text-align:center;padding-top:50px"><a href="" style="text-decoration:none"><img src="http://45.55.138.4/images/logo.png" width="305"  alt="" style="display:inline;border:0;max-width:305px" class="ss_logo"></a></td>' + '\n' +
      '</tr>' + '\n' +
  ...
  for (skey in  message.sites) {
    ...
    htmltext = htmltext + ' For other question please visit the <a href="http://45.55.138.4/r#!/help" target="_blank" style="color:#69666d;text-decoration:underline">help section</a> on our website or contact our <a href="mailto:rajib_2002bd@yahoo.com?Subject=Order%20' + purchaseId + '" target="_top" style="color:#69666d;text-decoration:underline">Customer Service Department</a></td></tr>' + '\n' +
      '<tr><td height="20"></td></tr>' + '\n' +
  ...
  htmltext = htmltext + '<tr><td height="5" style="line-height:5px;font-size:5px;background:#000000"></td></tr>' + '\n' +
    ...
    '<tr><td style="font-size:13px;font-weight: 700; line-height:18px;font-family:PT Sans,trebuchet ms, sans-serif;background:#000000;color:#ffffff;text-align:center"><a href="http://45.55.138.4/r#!/confirmation_placed_view/' + purchaseId + '/' + user_id + '" style="display: block;padding:5px 10px; text-decoration:none;color:#ffffff">VIEW DETAILS</a> </td></tr>' + '\n' +
    '</table>' + '\n' +
    '</td>' + '\n' +
    '</tr>' + '\n' +
  ...
  var email_order = new sendgrid.Email({
    ...
    ' To view your order use this link http://45.55.138.4/r#!/confirmation_placed_view/' + userDetails.purchase_id + '\n\n' +
