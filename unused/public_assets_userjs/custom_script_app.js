...
$(function(){
	$('.jcarousel.blogspot').mouseover(function(){
			$('.top_social_fll').hide();
			$('.top_social_tiny').show();
			$('.top-header .top-header-left .blogspot').css('padding-top', '46px');
			$('.top-header .top-header-left .blogspot img').css('padding-left', '16px');
			//$('.top-header .top-header-left .blogspot p').show();
		});

	$('.jcarousel.blogspot').mouseleave(function(){
	$('.top_social_tiny').hide();
			$('.top_social_tiny').css('padding-top', '0');
			$('.top_social_fll').fadeIn(300);
			$('.top-header .top-header-left .blogspot').css('padding-top', '6px');
...
$('.box-carousel-title').mouseover(function() {
	...
	$('h3.account-info').click(function() {
        $('.acc_div_hide').toggle();
        $('.after_clk_noti').toggle();
		
    });
    //	$('.h3.account-info').click(function() {
    //		$('.acc_div_hide').fadeOut(300);
    //	});
